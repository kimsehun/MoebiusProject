...
public class LocationVO implements Serializable {
	...
	private int location_addx;
	private int location_addy;
	...
	public int getLocation_addx() {
		return location_addx;
	}

	public void setLocation_addx(int location_addx) {
		this.location_addx = location_addx;
	}

	public int getLocation_addy() {
		return location_addy;
	}

	public void setLocation_addy(int location_addy) {
